...
<body>
    ...
    <table class="table-full">
        ...
        <tr>
            ...
            <td colspan="1" rowspan="3" class="border-black p-2 align-top">
    ...
    <table class="table-full">
        <thead>
            <tr>
                ...
                <th rowspan="2" class="border-black" style="width: 35%;">DESCRIPTION</th>
                ...
                <th rowspan="2" class="border-black" style="width: 8%;">Donor</th>
        ...
        <tbody>
            @for ($i = 0; $i < 5; $i++)
                <tr>
                    <td class="border-black text-center h-12">{{ $i + 1 }}</td>
                    <td class="border-black p-2 w-[400px]"></td>
                    <td class="border-black p-2 w-[50px] text-center">

                    </td>
                    <td class="border-black text-right p-2"></td>
                    <td class="border-black text-right p-2"></td>
                    <td class="border-black text-right p-2"></td>
                    <td class="border-black text-right p-2"> %</td>
                    <td class="border-black p-2 text-center"></td>
                    <td class="border-black p-2 text-center"></td>
                    <td class="border-black p-2 text-center"></td>
                </tr>
            @endfor
    ...
    <table class="table-full table-xs">
        ...
        <tr>
            ...
            <td class="border-black text-center" style="width:80px;">
        ...
        <tr>
            ...
            <td colspan="3" class="border-black align-top" style="height:32px;">
    ...
    <div class="signature-section">
        <div class="signature-container">
            ...
            <div class="signature-box text-left">
                <p class="text-base"><span class="font-bold">Prepared by:</span></p>
                <div class="signature-image-wrapper">

                </div>
                <div class="space-y-2">
                    <p><span class="font-bold">Position:</span></p>
