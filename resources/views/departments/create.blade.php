                ...
                <div class="w-16 h-16 rounded-2xl bg-white/20 flex items-center justify-center text-white">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" fill="none" viewBox="0 0 24 24"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0H5m14 0h2m-18 0h2" />
            ...
            <form action="{{ route('departments.store') }}" method="POST">
                ...
                <div class="mb-8">
                    ...
                    <textarea name="description" rows="5" placeholder="Enter department description"
                        class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-green-500 focus:border-green-500 focus:outline-none">{{ old('description') }}</textarea>
