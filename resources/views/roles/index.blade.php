                ...
                <table class="w-full">
                    ...
                    <thead class="bg-green-100">
                        ...
                        <tr>
                            ...
                            <th class="px-4 py-4 text-left text-xs font-bold uppercase text-gray-500">
                                Description
                            </th>

                            <th class="px-4 py-4 text-center text-xs font-bold uppercase text-gray-500">
                                Actions
                            </th>
