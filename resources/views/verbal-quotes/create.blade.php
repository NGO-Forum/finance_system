...
@section('content')
    <div class="max-w-full mx-auto">
        ...
        <form action="{{ route('verbal-quotes.store') }}" method="POST">
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 mb-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                    ...
                    <div>
                        ...
                        <input type="date" name="quote_date" value="{{ old('quote_date', date('Y-m-d')) }}"
                    ...
                    <div class="relative">
                        ...
                        {{-- Hidden User ID --}}
                        <input type="hidden" name="requested_by" id="requested_by_id" value="{{ old('requested_by') }}">

                        {{-- User Name --}}
                        <input type="text" id="requested_by_name" autocomplete="off" placeholder="Type user name..."
                            class="w-full rounded-xl border-gray-300 focus:ring-green-500 focus:border-green-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="contact_information" value="{{ old('contact_information') }}"
                    ...
                    <div>
                        ...
                        <input type="date" name="contact_date" value="{{ old('contact_date') }}"
                            class="w-full rounded-xl border-gray-300 focus:ring-green-500 focus:border-green-500">
                    ...
                    <div>
                        ...
                        <input type="time" name="contact_time" value="{{ old('contact_time') }}"
                            class="w-full rounded-xl border-gray-300 focus:ring-green-500 focus:border-green-500">
                    ...
                    <div class="relative">
                        ...
                        <input type="hidden" name="prepared_by" id="prepared_by_id" value="{{ old('prepared_by') }}">

                        <input type="text" id="prepared_by_name" autocomplete="off" placeholder="Type user name..."
                            class="w-full rounded-xl border-gray-300 focus:ring-green-500 focus:border-green-500">
                    ...
                    <div>
                        ...
                        <input type="date" name="prepared_date" value="{{ old('prepared_date', date('Y-m-d')) }}"
                            class="w-full rounded-xl border-gray-300 focus:ring-green-500 focus:border-green-500">
                        ...
                        <tbody id="itemTable">
                            ...
                            <tr>
                                ...
                                <td class="border px-3 py-2">
                                    ...
                                    <input type="text" name="budget_line[]" class="w-full rounded-lg border-gray-300">

                                </td>

                                <td class="border px-3 py-2">

                                    <textarea name="description[]" rows="1" required class="w-full rounded-lg mt-2 border-gray-300"></textarea>
                                ...
                                <td class="border px-3 py-2">
                                    ...
                                    <input type="number" step="0.01" value="0" readonly name="extended_price[]"
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 mt-4">
                ...
                <div>
                    ...
                    <textarea name="additional_specifications" rows="6" placeholder="Enter your specification"
                        class="w-full rounded-2xl border border-gray-300 px-4 py-4 text-gray-700 placeholder-gray-400 focus:bg-white focus:border-green-500 focus:ring-4 focus:ring-green-100 resize-none transition">{{ old('additional_specifications') }}</textarea>

                    @error('additional_specifications')
            ...
            <div class="bg-white rounded-2xl p-5 mt-4">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <div class="text-sm text-red-500">
                        ...
                        Please review all information before saving this verbal quotation.
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        {{-- Save --}}
                        <button type="submit"
                            class="inline-flex items-center gap-2 px-8 py-3 rounded-xl bg-gradient-to-r from-green-600 to-emerald-600 text-white font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function calculateGrandTotal() {
                ...
                table.querySelectorAll('tr').forEach(row => {
                    ...
                    row.querySelector('.extended-price').value = amount.toFixed(2);
            ...
            addRow.addEventListener('click', function() {
                ...
                row.querySelector('.extended-price').value = '0.00';
