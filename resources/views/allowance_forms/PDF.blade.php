...
<head>
    ...
    <style>
        ...
        /* Thick solid border between participants */
        .data-table tbody tr.participant-last-row td {
            border-bottom: 0.8pt solid #000 !important;
        }
            ...
            <tr>
                ...
                <td style="width: 25%; text-align: right;">
                    @foreach ($allowanceForm->donorLogos as $logo)
                        @if (!empty($logo->logo) && file_exists(public_path('storage/' . $logo->logo)))
                ...
                @foreach ($participantGroup as $participantIndex => $participant)
                    ...
                    @foreach ($allowanceTypes as $label => $field)
                        ...
                        <tr class="{{ $isLastRow ? 'participant-last-row' : '' }}">
                            ...
                            @if ($loop->index == 0)
                                <td class="text-center bold solid-border"
                                    style="border-bottom: none; padding-top: 1px;">
                                    TOTAL
                                </td>
                            @elseif ($loop->index == 1)
                            ...
                            @elseif ($loop->index == 3)
                                <td rowspan="3" class="solid-border"
                                    style="border-top: none; border-bottom: 0.8pt solid #000 !important;"></td>
                            @endif
        ...
        <table class="signature-table">
            <tr>
                <td style="width: 75%;">
                    ...
                    <span style="font-size: 7pt; margin-left: 100px;">(Signature, Name, Date)</span>
                </td>
                <td style="width: 25%;">
