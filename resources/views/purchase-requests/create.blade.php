                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" value="{{ $purchaseNo }}" readonly
                        ...
                        <div>
                            ...
                            <input type="text" name="donor" value="{{ old('donor') }}" placeholder="Enter donor name"
                                class="w-full rounded-xl border-slate-300 focus:ring-green-600 focus:border-green-600">
                        ...
                        <div>
                            ...
                            <input type="text" name="budget_line" value="{{ old('budget_line') }}"
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="purpose" rows="5" placeholder="Describe the purpose of this purchase request..."
                            class="w-full rounded-xl border-slate-300 focus:ring-green-600 focus:border-green-600" required>{{ old('purpose') }}</textarea>
                    ...
                    <div class="item-card border border-slate-200 rounded-2xl bg-slate-50 p-6">
                        ...
                        <div class="grid grid-cols-1 gap-5">
                            ...
                            <div>
                                ...
                                <textarea rows="3" name="items[0][specification]"
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-5 mt-5">
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" value="0" name="items[0][unit_cost]"
                            ...
                            <div>
                                ...
                                <input type="number" min="1" value="1" name="items[0][quantity]"
                            ...
                            <div>
                                ...
                                <input type="text" readonly value="0.00" name="items[0][total]"
