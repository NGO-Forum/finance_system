    ...
    <div class="min-h-screen">
        ...
        <div class="mx-auto max-w-full">
            ...
            <form id="financeForm" action="{{ route('finance-forms.store') }}" method="POST"
                ...
                {{-- Excel Refund sheet --}}
                {{-- Stored as cash_advance_settlement --}}

                <input type="hidden" name="transaction_type" value="cash_advance_settlement">
                ...
                <div class="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Calculate refund or additional disbursement from the settlement entries.
                        </p>
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-4">
                        ...
                        <div class="rounded-2xl bg-emerald-50 p-5">
                            ...
                            <p class="mt-1 text-xs text-emerald-600">
                                Cash returned to the organization.
                            </p>
