                ...
                <table style="width:100%; border-collapse:collapse; margin:0; padding:0;">
                    <tr>
                        <td
                            ...
                            NAME: {{ $goodsReceivedNote->supplier_name ?? '' }}
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:4px 6px; font-size:12px; font-weight:bold; line-height:1.5;">
                            ADDRESS: {{ $goodsReceivedNote->supplier_address ?? '' }}@if (!empty($goodsReceivedNote->supplier_phone))
                                -Tel: {{ $goodsReceivedNote->supplier_phone }}
                            @endif
                        </td>
                    </tr>
                </table>
    ...
    <div class="avoid-break">
        ...
        <table class="items-table">
            ...
            <tbody>
                ...
                @forelse ($goodsReceivedNote->items
                as $item)
                    <tr>
                        ...
                        <td class="{{ $item->accepted ? 'accepted' : 'center' }}">
                        ...
                        <td class="{{ $item->rejected ? 'rejected' : 'center' }}">
                ...
                @empty
                    ...
                    <tr>
                        ...
                        <td colspan="7" class="cell center" style="height:40px;color:#9ca3af;">
                ...
                @php
                    ...
                    $itemCount = $goodsReceivedNote->items->count();
