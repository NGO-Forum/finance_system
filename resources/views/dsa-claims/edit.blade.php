...
@section('content')
    ...
    <div class="max-w-full mx-auto">
        ...
        <form action="{{ route('dsa-claims.update', $claim) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6">
                        ...
                        <div>
                            ...
                            <input type="date" name="date_requested"
                                value="{{ old('date_requested', optional($claim->date_requested)->format('Y-m-d')) }}"
                            ...
                            <select name="department_id"
                                ...
                                @foreach ($departments as $department)
                                    <option value="{{ $department->id }}"
                                        {{ old('department_id', $claim->department_id) == $department->id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <input type="text" name="donor" value="{{ old('donor', $claim->donor) }}" required
                                class="w-full rounded-xl border-gray-300 focus:ring-green-500 focus:border-green-500">
                    ...
                    <div class="mt-6">
                        ...
                        <textarea name="purpose_of_travel" rows="4" required
                            class="w-full rounded-xl border-gray-300 focus:ring-green-500 focus:border-green-500">{{ old('purpose_of_travel', $claim->purpose_of_travel) }}</textarea>
                ...
                <div class="overflow-x-auto">
                    ...
                    <table class="min-w-full">
                        ...
                        <tbody id="travelTable" class="divide-y divide-gray-100">
                            ...
                            @forelse($claim->travels as $travel)
                                <tr class="hover:bg-green-50 transition">
                                    ...
                                    <td class="border px-4 py-4">
                                        ...
                                        <input type="text" name="from_location[]"
                                            value="{{ $travel->from_location }}" placeholder="Departure Location"
                                            class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring-green-500">
                                    ...
                                    <td class="border px-4 py-4">
                                        ...
                                        <input type="text" name="purpose[]" value="{{ $travel->purpose }}"
                                            placeholder="Meeting / Workshop / Training..."
                                            class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring-green-500">
                                    ...
                                    <td class="border px-4 py-4 w-16">
                                        ...
                                        <input type="time" name="arrival_time[]" value="{{ $travel->arrival_time }}"
                                            class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring-green-500">
                            ...
                            @forelse($claim->items as $item)
                                <tr class="hover:bg-green-50 transition">
                                    ...
                                    <td class="border px-4 py-4">
                                        ...
                                        <input type="number" step="0.01" value="{{ $item->breakfast }}"
                                            name="breakfast[]"
                                    ...
                                    <td class="border px-4 py-4">
                                        ...
                                        <input type="number" step="0.01" value="{{ $item->lunch }}" name="lunch[]"
                                            class="expense-input w-full rounded-lg border-gray-300 text-right focus:border-green-500 focus:ring-green-500">
                                    ...
                                    <td class="border px-4 py-4">
                                        ...
                                        <input type="number" step="0.01" value="{{ $item->dinner }}"
                                            name="dinner[]"
                                            class="expense-input w-full rounded-lg border-gray-300 text-right focus:border-green-500 focus:ring-green-500">
                                    ...
                                    <td class="border px-4 py-4">
                                        ...
                                        <input type="number" step="0.01" value="{{ $item->accommodation }}"
                                            name="accommodation[]"
                                            class="expense-input w-full rounded-lg border-gray-300 text-right focus:border-green-500 focus:ring-green-500">
                                    ...
                                    <td class="border px-4 py-4">
                                        ...
                                        <input type="number" step="0.01" value="{{ $item->transport }}"
                                            name="transport[]"
                                            class="expense-input w-full rounded-lg border-gray-300 text-right focus:border-green-500 focus:ring-green-500">
                                    ...
                                    <td class="border px-4 py-4">
                                        ...
                                        <input type="number" step="0.01" value="{{ $item->incident }}"
                                            name="incident[]"
                                            class="expense-input w-full rounded-lg border-gray-300 text-right focus:border-green-500 focus:ring-green-500">
                                    ...
                                    <td class="border px-4 py-4 bg-green-50">
                                        ...
                                        <input type="text" readonly value="{{ $item->total }}" name="total[]"
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <div>
                                        ...
                                        <h3 class="text-3xl font-bold">
                                            ...
                                            $<span id="grandTotal">{{ number_format($claim->grand_total, 2) }}</span>
            ...
            <div class="mt-4 bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <textarea name="note" rows="2" placeholder="Enter your note"
                        class="w-full rounded-xl border-gray-300 shadow-sm focus:border-green-500 focus:ring-2 focus:ring-green-300 transition resize-none">{{ old('note', $claim->note) }}</textarea>
            ...
            <div class="mt-6 bg-gradient-to-r from-green-600 to-emerald-500 rounded-2xl shadow-lg text-white">
            ...
            {{-- Action Buttons --}}
            <div class="mt-8 bg-white rounded-2xl shadow-xl border border-gray-200">
